...
private fun VectorPreview() {
    KPIcon(KPIcons.Fill.Tick, KPIconSize.XXXLarge)
}

public val KPIcons.Fill.Tick: ImageVector by lazy {
    ImageVector.Builder(
        name = "Tick",
        defaultWidth = 20.dp,
        defaultHeight = 21.dp,
...
@Deprecated(
    message = "Use KPIcons.Fill.Tick instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.Tick"
    ),
