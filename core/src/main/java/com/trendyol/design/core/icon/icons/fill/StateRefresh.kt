...
public val KPIcons.Fill.StateRefresh: ImageVector by lazy {
    ImageVector.Builder(
        name = "Refresh",
        defaultWidth = 64.dp,
        defaultHeight = 64.dp,
...
@Deprecated(
    message = "Use KPIcons.Fill.StateRefresh instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.StateRefresh"
    ),
