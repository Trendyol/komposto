...
private fun CargoImageVectorPreview() {
    KPIcon(imageVector = KPIcons.Fill.Cargo, size = KPIconSize.XXXLarge)
}

public val KPIcons.Fill.Cargo: ImageVector by lazy {
    ImageVector.Builder(
        name = "Cargo",
        defaultWidth = 14.dp,
        defaultHeight = 14.dp,
...
@Deprecated(
    message = "Use KPIcons.Fill.Cargo instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.Cargo"
    ),
