...
private fun VectorPreview() {
    KPIcon(KPIcons.Outline.Info, KPIconSize.XXXLarge)
}

public val KPIcons.Outline.Info: ImageVector by lazy {
    ImageVector.Builder(
        name = "Info",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
...
@Deprecated(
    message = "Use KPIcons.Outline.Info instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Outline.Info"
    ),
