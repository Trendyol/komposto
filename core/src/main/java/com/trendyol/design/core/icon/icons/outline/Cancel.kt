...
public val KPIcons.Outline.Cancel: ImageVector by lazy {
    ImageVector.Builder(
        name = "Cancel",
        defaultWidth = 32.dp,
        defaultHeight = 32.dp,
...
@Deprecated(
    message = "Use KPIcons.Outline.Cancel instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Outline.Cancel"
    ),
