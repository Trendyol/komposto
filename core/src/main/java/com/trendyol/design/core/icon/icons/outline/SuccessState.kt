...
@Deprecated(
    message = "Use KPIcons.Outline.SuccessState instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Outline.SuccessState"
    ),
    level = DeprecationLevel.WARNING
)
public val Icons.Outline.SuccessState: ImageVector
    get() {
        if (_SuccessState != null) {
            return _SuccessState!!
        }
        _SuccessState = ImageVector.Builder(
            name = "SuccessState",
            defaultWidth = 64.dp,
            defaultHeight = 64.dp,
            viewportWidth = 64f,
