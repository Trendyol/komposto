...
private fun RunningOutVectorPreview() {
    KPIcon(imageVector = KPIcons.Fill.RunningOut, size = KPIconSize.XXXLarge)
}

public val KPIcons.Fill.RunningOut: ImageVector by lazy {
    ImageVector.Builder(
...
@Deprecated(
    message = "Use KPIcons.Fill.RunningOut instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.RunningOut"
    ),
