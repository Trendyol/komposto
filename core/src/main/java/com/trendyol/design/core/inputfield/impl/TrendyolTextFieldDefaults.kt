...
internal fun KPOutlinedTextFieldDecorationBox(
    value: String,
    ...
    KPCommonDecorationBox(
        type = KPTextFieldType.Outlined,
        value = value,
        visualTransformation = visualTransformation,
...
@ExperimentalMaterialApi
@Deprecated(
    message = "There are no planned replacement for this function. If you need one contact with us." +
