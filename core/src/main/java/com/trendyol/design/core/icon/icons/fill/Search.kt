...
private fun SearchPreview() {
    KPIcon(imageVector = KPIcons.Fill.Search, size = KPIconSize.XXXLarge)
}

public val KPIcons.Fill.Search: ImageVector by lazy {
    ImageVector.Builder(
        name = "Search",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
...
@Deprecated(
    message = "Use KPIcons.Fill.Search instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.Search"
    ),
    level = DeprecationLevel.WARNING
)
public val Icons.Fill.Search: ImageVector by lazy {
    ImageVector.Builder(
        name = "Search",
        defaultWidth = 20.dp,
        defaultHeight = 20.dp,
