...
private fun VectorPreview() {
    KPIcon(KPIcons.Outline.Union, KPIconSize.XXXLarge)
}

public val KPIcons.Outline.Union: ImageVector by lazy {
    ImageVector.Builder(
        name = "Union",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
...
@Deprecated(
    message = "Use KPIcons.Outline.Union instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Outline.Union"
    ),
