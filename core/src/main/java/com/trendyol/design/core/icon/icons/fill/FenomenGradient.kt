...
public val KPIcons.Fill.FenomenGradient: ImageVector by lazy {
    ImageVector.Builder(
        name = "HeartStar",
        defaultWidth = 14.dp,
        defaultHeight = 14.dp,
...
@Deprecated(
    message = "Use KPIcons.Fill.FenomenGradient instead for consistent naming. " +
        "This API will get removed in future releases.",
    replaceWith = ReplaceWith(
        expression = "KPIcons.Fill.FenomenGradient"
    ),
