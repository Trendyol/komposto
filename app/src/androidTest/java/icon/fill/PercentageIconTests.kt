...
internal class PercentageIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.Percentage,
    ...
    @Test
    fun percentageIconTests() = runScreenShotTest(
        testName = "Percentage Icon Tests",
        contents = contents
    )
}
