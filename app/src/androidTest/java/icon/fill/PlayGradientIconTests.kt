...
internal class PlayGradientIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.PlayGradient,
    ...
    @Test
    fun playGradientIconTests() = runScreenShotTest(
        testName = "Play Gradient Icon Tests",
        contents = contents
    )
}
