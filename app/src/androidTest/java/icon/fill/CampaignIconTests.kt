...
internal class CampaignIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.Campaign,
    ...
    @Test
    fun campaignIconTests() = runScreenShotTest(
        testName = "Campaign Icon Tests",
        contents = contents
    )
}
