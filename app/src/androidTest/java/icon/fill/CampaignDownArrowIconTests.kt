...
internal class CampaignDownArrowIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.CampaignDownArrow,
    ...
    @Test
    fun campaignDownArrowIconTests() = runScreenShotTest(
        testName = "Campaign Down Arrow Icon Tests",
        contents = contents
    )
}
