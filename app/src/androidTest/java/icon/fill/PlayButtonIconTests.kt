...
internal class PlayButtonIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.PlayButton,
    ...
    @Test
    fun playButtonIconTests() = runScreenShotTest(
        testName = "Play Button Icon Tests",
        contents = contents
    )
}
