...
internal class FavoriteSelectedIconTests : DesignScreenshotTest() {
    private val contents = listOf(
        DesignScreenshotTestContainer("XXSmall") {
            BoxWithHorizontalPadding {
                KPIcon(
                    imageVector = KPIcons.Fill.FavoriteSelected,
    ...
    @Test
    fun favoriteSelectedIconTests() = runScreenShotTest(
        testName = "Favorite Selected Icon Tests",
        contents = contents
    )
}
